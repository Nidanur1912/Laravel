...
class ObatController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            $array = $request->only([
            'kode_obat','nama_obat','merk','jenis','satuan','golongan','kemasan','harga_jual','stok'
            ]);
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            $obat->save();
            return redirect()->route('obat.index')->with('success_message', 'Berhasil obat');
    }
    ...
    public function destroy(string $id)
    {
        $obat = Obat::find($id);
        if ($obat) $obat->delete();
        return redirect()->route('obat.index')->with('success_message', 'Berhasil menghapus bidang studi');
    }
}
