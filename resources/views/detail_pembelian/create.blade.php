                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="nonota_beli">ID Pembelian</label>
...
@error('nonota_beli') is-invalid @enderror"
                                    ...
                                    value="{{ old('nonota_beli') }}" arialabel="ID Pembelian" aria-describedby="cari" readonly>
...
@error('harga_beli') is-invalid @enderror"
                                id="harga_beli" placeholder="Harga Beli" name="harga_beli" value="{{ old('harga_beli') }}">
                            @error('harga_beli')
